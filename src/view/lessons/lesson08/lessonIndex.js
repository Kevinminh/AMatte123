        ...
        <Body>
          <div className="overall-container">
            ...
            <div className="lesson-container">
              <Router history={history}>
                <Route exact path="/kurs/lesson/080" component={Lesson1} />
                <Route exact path="/kurs/lesson/81" component={Lesson2} />
                <Route exact path="/kurs/lesson/82" component={Lesson3} />
                <Route exact path="/kurs/lesson/83" component={Lesson4} />
              </Router>
            </div>
          </div>
        </Body>
