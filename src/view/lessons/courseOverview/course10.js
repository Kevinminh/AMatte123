...
import { Kurs10 as Course } from "../../../modules/api/courseData/courseInfo";
    ...
    return (
      <div>
        ...
        <OverView
          ...
          kap1Ls4={Course.kap1Ls4}
          kap1Qs4={Course.kap1Qs4}
          // KAP 2
          kap2={Course.kap2}
          kap2L={Course.kap2L}
          kap2Q={Course.kap2Q}
          ...
          kap7Q={Course.kap7Q}
          kap7s={Course.kap7s}
          kap7Ls={Course.kap7Ls}
          kap7Qs={Course.kap7Qs}
          kap7s1={Course.kap7s1}
          kap7Ls1={Course.kap7Ls1}
          kap7Qs1={Course.kap7Qs1}
          kap7s2={Course.kap7s2}
          kap7Ls2={Course.kap7Ls2}
          kap7Qs2={Course.kap7Qs2}
          kap7s3={Course.kap7s3}
          kap7Ls3={Course.kap7Ls3}
          kap7Qs3={Course.kap7Qs3}
          kap7s4={Course.kap7s4}
          kap7Ls4={Course.kap7Ls4}
          kap7Qs4={Course.kap7Qs4}
          // TEST
          test={Course.test}
          testL={Course.testL}
          testQ={Course.testQ}
